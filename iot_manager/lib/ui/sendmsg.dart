...
class SendMessageDialog extends StatefulWidget {
  ...
  SendMessageDialog({@required this.client});


  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _SendMessageDialogState();
  }
...
//                },
            ...
            new RaisedButton(
              child: Text ('Send'),
              onPressed: (){
                if(messageController.value.text.isNotEmpty && topicController.value.text.isNotEmpty) {
                  _messageContent = messageController.value.text;
                  _topicContent = topicController.value.text;
                  _sendMessage();
                }
